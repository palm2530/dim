	...
	<div class="body-inner">
		...
		<div id="main-slide" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item <?php echo $i==1 ? 'active' : ''?>" style="background-image:url(<?php echo '../uploads/'.$ROW['imagesPath'] ?>)">
						...
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?php echo '../uploads/'.$ROW['imagesPath'] ?>" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
									<a href="news-single.html"><?php echo $ROW['title'] ?></a>
								</h4>
